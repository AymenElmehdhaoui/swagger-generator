...
var Generate = /** @class */ (function () {
    function Generate(config) {
        ...
        utils_1.Utils.generateOutDirFolder(config.outDir);
    }
    Object.defineProperty(Generate.prototype, "setData", {
        get: function () {
            var filePath = path_1.default.normalize(this.config.filePath);
            return utils_1.Utils.fileReader(filePath);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Generate.prototype.doGenerateModels = function () {
        ...
        this.usedModels$
            ...
            models.map(function (model) {
                var viewPath = path_1.default.resolve('./src/templates/model.mustache');
    ...
    Generate.prototype.doGenerateServices = function () {
        ...
        this.usedService$
            ...
            var viewPath = path_1.default.resolve('./src/templates/service.mustache');
            var template = fs_1.default.readFileSync(viewPath, 'utf-8').toString();
